            ...
            <section className="text-gray-900 bg-lime-50">
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        <h1 className="text-font font-bold leading-none text-4xl md:text-5xl lg:text-6xl">Used Item
                    ...
                    <div className="banner-container flex items-center justify-center py-6 mt-8 lg:mt-0 ">
                        <img src={banner1} alt="" className="banner-image object-cover duration-300 hover:scale-105  lg:w-[800px] " />
                    </div>
                </div>
